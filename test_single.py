...
def main():
    ...
    parser.add_argument('checkpoint', help="Model checkpoint (or 'pretrained=<model_id>')")
                        # default='/home/cindy/.cache/torch/hub/checkpoints/parseq-bb5792a6.pt')
    parser.add_argument('--data_root', default='/home/cindy/PycharmProjects/data/ocr/test_ours')
    ...
    for name, dataloader in datamodule.test_dataloaders(test_set).items():
        ...
        for imgs, labels in tqdm(iter(dataloader), desc=f'{name:>{max_width}}'):
            new_imgs = imgs
            res = model.test_step((new_imgs.to(model.device), labels), -1)['output']
